 ...
 * Class declaration
 */
class Cp1252 extends CpConvert {
  private final char[] Cp1252 =
    {
      (char) 0x0000,
      (char) 0x0001,
      (char) 0x0002,
      ...
      if (raw[i] <= 0x007F) {
        ...
        switch (raw[i]) {
          ...
          case (char) 0x0152 :
            data[i] = (byte) 140;
            break;
            //					case (char)0xFFFD : data[i] = (byte)141; break;
          case (char) 0x017D :
            data[i] = (byte) 142;
            break;
            //					case (char)0xFFFD : data[i] = (byte)143; break;
          ...
          case (char) 0x0153 :
            data[i] = (byte) 156;
            break;
            //					case (char)0xFFFD : data[i] = (byte)157; break;
          case (char) 0x017E :
            data[i] = (byte) 158;
            break;
          case (char) 0x0178 :
          ...
          default :
            data[i] = (byte) 0x20; // BLANK or SPACE
        }
      }
    }
    return data;
  ...
  public final String toString(final byte[] input, final int offset, final int length)
    ...
    for (int i = length; --i >= 0;) {
      charData[i] = Cp1252[(0xFF & input[i + offset])];
    }
